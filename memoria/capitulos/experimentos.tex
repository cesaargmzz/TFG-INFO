...
crecimiento real durante el periodo de prueba. Esto es una señal inequívoca de que la
relación lineal entre desempleo y PIB no captura la dinámica de recuperación y estabilización
...
imponer una forma funcional rígida. Los experimentos de los Bloques 0--2 confirman que
este salto en complejidad se traduce en una mejora consistente del error de predicción.
...
El entrenamiento con datos combinados de los tres países produce mejoras generalizadas respecto al Bloque~0, siendo el efecto más significativo la rehabilitación del modelo ampliado para España, que pasa de ser el peor resultado individual (MAE 0.796) al mejor del bloque (MAE 0.297). Este resultado confirma que el sobreajuste observado en el Bloque~0 era fundamentalmente un problema de escasez de datos de entrenamiento, no una limitación inherente de las variables seleccionadas.
...
el modelo prácticamente ignora la información de identidad nacional, lo que indica que la
información geográfica ya está codificada de forma implícita en la dinámica autorregresiva
de cada economía.
...
Desde una perspectiva metodológica, este experimento confirma que las variables de
identidad categórica ---país, sector, empresa--- en modelos de series temporales
macroeconómicas son secundarias respecto a las variables de estado autorregresivas. El nivel
...
El modelo ampliado del Bloque~2 (\texttt{panel\_geo\_ext}) se consolida como la
configuración con mejor rendimiento agregado de todos los bloques, obteniendo
simultáneamente el mejor MAE para España (0.290), el segundo mejor para Francia (0.224
frente a 0.215 del Bloque~1) y el mejor para Italia (0.365 frente a 0.376 del Bloque~1).
Estos resultados motivan la exploración del Bloque~3, donde se analizará la capacidad de
transferencia entre economías entrenando con los datos de dos países y evaluando sobre el
tercero.