...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Título y subtítulo
\newcommand{\titulo}{Predicción del PIB y análisis del impacto de la política monetaria mediante modelos de inteligencia artificial}
\newcommand{\subtitulo}{}
% Datos del autor
...
\input{capitulos/experimentos}		% Plantilla: Se muestran listados
\input{capitulos/app}
